...
[How to update to version 10.0.0](How-To-Update.md#to-version-10-0-0)
...
## 9.4.0
1. Update Api version [9.4](https://core.telegram.org/bots/api-changelog#february-9-2026)

## 9.3.0
1. Update Api version [9.3](https://core.telegram.org/bots/api-changelog#december-31-2025)
2. Bug fixes: #1548, #1544, #1545, #1546, #1547, #1550, #1552, #1555, #1558

## 9.2.0
1. Update Api version [9.2](https://core.telegram.org/bots/api-changelog#august-15-2025)
2. Bug fixes: #1541

## 9.1.0
1. Update Api version [9.1](https://core.telegram.org/bots/api-changelog#july-3-2025)
2. Bug fixes: #1526, #1527, #1535

## 9.0.0
1. Update Api version [9.0](https://core.telegram.org/bots/api-changelog#april-11-2025)
2. Bug fixes: #1501
